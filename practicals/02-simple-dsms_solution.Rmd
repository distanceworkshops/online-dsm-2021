...
and at the plot of the smooths alone:
...
We can then again use the `kable` function to make a table, in this case sorting by AIC
...
We'll discuss how to decide between the models in the lectures!
