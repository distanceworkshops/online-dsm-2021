...
```{r sample-tab}
# load dplyr for data manipulations
library(dplyr)
...
```{r Nhat-dht}
Nhat_dht_hr_beau <- dht(model=df_hr_beau_dht$ddf, 
...
(There's a slight difference here because `dht` uses the average group size, rather than the exact )
